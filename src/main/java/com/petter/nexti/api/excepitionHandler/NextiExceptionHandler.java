...
////////CLASSE RESPONSAVEL POR POR INSTANCIAR METODOS QUE LANÇAM EXCEÇÕES/////////

@AllArgsConstructor
@ControllerAdvice
public class NextiExceptionHandler extends ResponseEntityExceptionHandler {
...
private MessageSource ms;
	...
	public ResponseEntity<Object> handleCadastroPessoaException(CadastroClienteException ccx, WebRequest request){
